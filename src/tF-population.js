...
${FigW(pyramidShapesSvg(), T`The three basic pyramid shapes: expansive (many births, young population), stationary (births and deaths both low and steady) and constrictive (fewer births than before, ageing).`)}
...
${Fig(planeSvg({ W: 360, H: 220, x: [1965, 2025], y: [0, 65], step: [10, 10], tickX: 10, fmtX: v => String(v), xl: T`year`, yl: '%', extra: (X, Y) => sPline([[1971, 17.3], [1980, 22.3], [1990, 30.9], [2000, 42.0], [2010, 49.8], [2020, 56.7]].map(([a, b]) => [X(a), Y(b)]), 'mf-c1', ' fill="none" stroke-width="2.2"'), pts: [[1971, 17.3, F(17.3), 'start', false, 8, 14], [1990, 30.9], [2000, 42.0], [2010, 49.8], [1980, 22.3], [2020, 56.7, F(56.7), 'end', false, 8, -6]], label: T`Share of Indonesians living in urban areas rising from 17 percent in 1971 to 57 percent in 2020` }), T`Urbanisation in Indonesia: the urban share of the population by census year (BPS), from 17% in 1971 to 57% in 2020.`)}
...
${Fig(planeSvg({ W: 360, H: 220, x: [1965, 2025], y: [0, 6.5], step: [10, 1], tickX: 10, fmtX: v => String(v), xl: T`year`, yl: 'TFR', extra: (X, Y) => sPline([[1971, 5.61], [1980, 4.68], [1990, 3.33], [2000, 2.34], [2010, 2.41], [2020, 2.18]].map(([a, b]) => [X(a), Y(b)]), 'mf-c1', ' fill="none" stroke-width="2.2"') + sL(X(1965), Y(2.1), X(2025), Y(2.1), 'mf-c2', ' stroke-dasharray="5 4"') + sT(X(2024), Y(2.1) + 16, T`replacement level 2.1`, 'mf-small', 'end'), pts: [[1971, 5.61, F(5.61), 'start', false, 8, -4], [1980, 4.68], [1990, 3.33], [2000, 2.34], [2010, 2.41], [2020, 2.18, F(2.18), 'end', false, 8, -8]], label: T`Total fertility rate of Indonesia falling from 5.6 children per woman in 1971 to 2.2 in 2020` }), T`Indonesia's total fertility rate by census (BPS): from 5.6 children per woman in 1971 to 2.2 in 2020, close to the replacement level of about 2.1.`)}
...
${FigW(hdiSvg(), T`The HDI combines three dimension indices by their geometric mean, so a very low score in one dimension cannot be fully made up by the others.`)}
