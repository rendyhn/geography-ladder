...
${Fig(bufferSvg(), T`<b>Buffers</b> are zones of equal distance around features: here 100 m along a river and around two wells. Overlaying them with the houses shows which homes are at risk of flooding or depend on each well.`)}
<h3>Other tools</h3>
...
${Fig(planeSvg({ W: 340, H: 230, x: [0, 1.05], y: [0, 1.05], equal: true, step: [0.25, 0.25], tickX: 0.5, tickY: 0.5, xl: 'a/A', yl: 'h/H', fns: [{ f: x => 1 - x ** 3, to: 1, label: 'HI 0.75', at: 0.72, dx: 6, dy: -4 }, { f: x => 1 - x, to: 1, cls: 'mf-c2', label: 'HI 0.5', at: 0.52, dx: 6, dy: -2 }, { f: x => (1 - x) ** 3, to: 1, cls: 'mf-c3', label: 'HI 0.25', at: 0.3, dx: 6, dy: -2 }], label: T`Hypsometric curves: convex for a young landscape, straight for a mature one and concave for an old, worn-down one` }), T`Hypsometric curves (relative height against relative area above it). The area under each curve is the hypsometric integral: high for young, little-eroded land, low for old, worn-down land.`)}
...
${Fig(propCirclesSvg(), T`Proportional circles: a value 9 times larger gets a circle with 9 times the area but only 3 times the radius.`)}
...
${FigW(cycleSvg([T`Problem`, T`Literature`, T`Hypothesis`, T`Data`, T`Analysis`, T`Conclusion`], { center: T`Research cycle`, label: T`The research cycle: problem, literature review, hypothesis, data collection, analysis and conclusion, leading to new problems` }), T`Research is a cycle: conclusions raise new problems to study.`)}
<h3>Sampling</h3>
